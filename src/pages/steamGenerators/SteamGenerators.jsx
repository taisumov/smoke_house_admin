...
import style from "./SteamGenerators.module.css";
...
const SteamGenerators = () => {
  ...
  useEffect(() => {
    //setIsLoading(true);
    host
      .post("/api/item/all/get/category", { category: "Парогенераторы" })
      .then((res) => {
        console.log(res["data"]);
        setCatalog(res["data"]);
  ...
  return (
    <div className={style.container}>
          ...
          <div className={style.product}>
            ...
            <div className={style.changeButton}>
              <MButton
                onClick={() => {
                  navigate(
                    `/catalog/edit/${product["slug"]}&${"Парогенераторы"}`
                  );
                }}
              >
                Редактировать
      ...
      <div className={style.createButton}>
        <MButton
          onClick={() => {
            navigate(`/catalog/create/Парогенераторы`);
          }}
        >
          Добавить
        </MButton>
